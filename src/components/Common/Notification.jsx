...
function NotificationCard({ confirmModal, onConfirm, onCancel }) {
    ...
    const circleBg = isVerify || isActivate ? "#10B935" : "#E21E26";
    const glowShadow = isVerify || isActivate
                    ...
                    <div className="flex justify-center gap-4">
                        {actionType === "resetPassword" && (
                            <>
                                ...
                                <button
                                    onClick={onConfirm}
                                    className="bg-[#FFCC00] text-black px-8 py-3 rounded-xl font-bold min-w-[200px]"
                                >
                                    Send Link
                                </button>
                            </>
                        ...
                        {actionType === "activate" && (
                            <>
                                ...
                                <button
                                    onClick={onConfirm}
                                    className="bg-[#10B935] text-white px-8 py-3 rounded-xl font-semibold min-w-[200px]"
                                >
                                    Activate Account
                                </button>
                            </>
                        ...
                        {isReject && (
                            <>
                                ...
                                <button
                                    onClick={onConfirm}
                                    className="bg-[#E21E26] text-white px-8 py-3 rounded-xl font-semibold min-w-[200px]"
                                >
                                    Reject Account
                                </button>
                            </>
