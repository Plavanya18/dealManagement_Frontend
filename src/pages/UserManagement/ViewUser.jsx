                        ...
                        <div className="mb-4">
                            ...
                            <div className="flex items-center justify-between p-3  rounded-lg bg-white">
                                ...
                                <label className="inline-flex relative items-center cursor-pointer">
                                    ...
                                    />
                                    <div className="w-11 h-6 bg-gray-200 rounded-full peer peer-checked:bg-yellow-500 peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border after:border-gray-300 after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                                </label>
                            </div>
                        </div>
